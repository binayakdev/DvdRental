...
namespace Semester2Coursework.Controllers
{
    public class LoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MemberId,AlbumId,issueDate,returnDate,fineamount")] Loan loan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MemberId,AlbumId,issueDate,returnDate,fineamount")] Loan loan)
        {
            if (ModelState.IsValid)
            {
